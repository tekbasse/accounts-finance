...
if { [qf_is_natural_number $table_tid] } {
    set table_stats_list [qss_table_stats $table_tid $instance_id]
    ...
    set table_lists [qss_table_read $table_tid $instance_id]
    ...
    if { $table_flags eq "p4" } {
        ...
        if { $table_flags eq "dc" } {
            ...
            set pie_html [acc_fin::pretti_html_view $pie_filename]
            # cobbler chart
            set cob_filename [acc_fin::pretti_cobbler_filename $table_id]
