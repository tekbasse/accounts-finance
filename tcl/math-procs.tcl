...
ad_proc -public qaf_interpolatep1p2_at_x {
    ...
    Method 0 returns y value of third point (p3), given cartesion points p1(x,y), p2(x,y). if avg_p == 1, returns the average of p1_y and p2_y instead of returning an empty string. 
    Method 1 returns y value of third point (p3) assuming p2_x > p1_y and p3_x is between p1_x and p2_x.
