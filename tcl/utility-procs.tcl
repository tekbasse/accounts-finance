...
ad_proc -public acc_fin::pie_file_create {
    ...
    # set pie_filename "pretti-dc-${table_tid}-cob.png"
    # scrub pie_filename. based on template::data::validate::filename
    regsub -all -- {[^a-zA-Z0-9\.\_\-]} $pie_filename {_} pie_filename
