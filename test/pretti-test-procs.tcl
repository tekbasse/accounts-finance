...
"
            ...
            foreach table_row [lrange $table_rows_list 1 end] {
                ...
                foreach n_points $n_points_list {
                    ...
                    aa_equals "Activity $activity: Curve Te matches expected Te" $expected_time $curv_avg_fmt
                    # also confirm curve's representation at critical original parameters o,m,p:
                    set optimistic2 [qaf_y_of_x_dist_curv 0 $curve2_lol 1]
                    set median2 [qaf_y_of_x_dist_curv .5 $curve2_lol 1]
                    set pessimistic2 [qaf_y_of_x_dist_curv 1 $curve2_lol 1]
                    aa_equals "Activity $activity: Curve Te matches @ optimistic" $optimistic $optimistic2
                    aa_equals "Activity $activity: Curve Te matches @ median" $median $median2
                    aa_equals "Activity $activity: Curve Te matches @ pessimistic" $pessimistic $pessimistic2
