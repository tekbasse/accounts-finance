set title "PRETTI #accounts-finance.task_types_p3#"

set type "p3"

set context [list [list index "Documentation"] $title]

set p3_text [lindex [acc_fin::example_table p30g] 2]
set raw_html "<pre>"
append raw_html $p3_text
append raw_html "</pre>"
...
set p3_list [list ]
set p3_text_list [split $p3_text "\n"]
foreach row $p3_text_list {
    regsub -all -- " " $row ";" row2
...
set raw2_html [qss_list_of_lists_to_html_table $p3_list $table_attribute_list]
